...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-brown text-left text-base font-medium text-white bg-brown-light focus:outline-none transition duration-150 ease-in-out'
