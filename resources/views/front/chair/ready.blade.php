...
@section("content")
    ...
    <div id="info-text">
        <div class="container">
            ...
            <p class="acceptance"><label><input type="checkbox" name="acceptance" value="1" > <span><span>{{ __("Согласен с") }} <a href="https://relaxtime.lv/garantijas-un-piegades-noteikumi/" target="_blank">{{ __("правилами использования") }}</a> {{ __("массажного кресла") }}</span></span></label></p>
